...
async function GAMES202Main() {
	...
	//If you want to see the PhongMaterial, add this light
	// let lightPos = [0, 80, 80];
	// const directionLight = new DirectionalLight([1, 1, 1], lightPos, true, renderer.gl);
	// renderer.addLight(directionLight);

	// Add shapes
	let skyBoxTransform = setTransform(0, 50, 50, 150, 150, 150);
	let boxTransform = setTransform(-20, 0, 20, 15, 15, 15);
	let box2Transform = setTransform(20, 0, 20, 10, 10, 10);
	...
	function createGUI() {
		...
		const panelModel = gui.addFolder('Switch Environemt Map');
