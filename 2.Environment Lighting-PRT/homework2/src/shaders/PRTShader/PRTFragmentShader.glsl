...
vec3 SHDot(mat3 uPrecomputeLR, mat3 uPrecomputeLG, mat3 uPrecomputeLB, mat3 vPrecomputeLT){
...
void main(void){    
    vec3 result = SHDot(uPrecomputeLR, uPrecomputeLG, uPrecomputeLB, vPrecomputeLT);
